...
|5 production path|Выбранный runtime + один day/week worker/API|Roundtrip/failure/rollout tests; согласованные legacy client migration|Общий внутренний day/week loop подготовлен; API/worker contract ещё не переключён|
