"""Transitional mode dispatcher and legacy structured-output pipeline.

Agentic execution lives in runtime.py. Keep this facade until API/worker cutover.
"""
...
from app.core.agent.contracts import GeneratedDayResult as GeneratedDayResult
from app.core.agent.observability import build_plan_observability as build_plan_observability
...
async def generate_day_plan(
    ...
    *,
    ...
    if settings.AGENT_TOOL_USE_ENABLED:
        return await runtime.generate_day_plan(
            user_profile,
            day_number,
